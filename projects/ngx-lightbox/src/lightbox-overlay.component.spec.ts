...
describe('[ Unit - LightboxOverlayComponent ]', () => {
  ...
  it('should init the component with correct styling', () => {
    expect(fixture.nativeElement.getAttribute('class')).toContain(
      'animation fadeInOverlay lightboxOverlay'
    );
    expect(fixture.nativeElement.getAttribute('style')).toMatch(
  ...
  describe('{ method: close }', () => {
    it('should self destroy and broadcast event when component is closed', fakeAsync(() => {
      ...
      expect(lightboxEvent.broadcastLightboxEvent).toHaveBeenCalledWith({
      ...
      fixture.detectChanges();
      expect(fixture.nativeElement.getAttribute('class')).toContain(
        'animation lightboxOverlay fadeOutOverlay'
      );
  ...
  describe('{ method: ngOnDestroy }', () => {
    it('should unsubscribe event when destroy is called', () => {
      spyOn(
        fixture.componentInstance['_subscription'],
        'unsubscribe'
      ).and.callFake(() => {});
      fixture.componentInstance.ngOnDestroy();
      expect(
        fixture.componentInstance['_subscription'].unsubscribe
